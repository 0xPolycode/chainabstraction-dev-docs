  ...
  head() {
    return (
      <>
        ...
        <script defer data-domain="ca.dev" src="https://plausible.io/js/script.js"></script>
      </>
    )
  },
          ...
          items: [
            {
              ...
              collapsed: true,
              items: [
                { text: 'Klaster', link: '/ecosystem/orchestration/klaster' },
                { text: 'Agoric', link: '/ecosystem/orchestration/agoric' },
                { text: 'Okto', link: '/ecosystem/orchestration/okto' },
                { text: 'Orb Labs', link: '/ecosystem/orchestration/orb' },
                { text: 'Aarc', link: '/ecosystem/orchestration/aarc' },
              ],
            },
            {
              ...
              collapsed: true,
              items: [
                { text: 'Biconomy', link: '/ecosystem/account-abstraction/biconomy' },
                { text: 'Safe', link: '/ecosystem/account-abstraction/safe' },
            ...
            {
              text: "Interoperability and Bridging",
              collapsed: true,
              items: [
                { text: "Catalyst", link: "/ecosystem/interoperability-bridging/catalyst" },
                { text: "Socket", link: "/ecosystem/interoperability-bridging/socket" },
                { text: "Across+", link: "/ecosystem/interoperability-bridging/across" },
                { text: "Synapse", link: "/ecosystem/interoperability-bridging/synapse" },
            ...
            {
              text: "Web3 Innovation Hubs",
              collapsed: true,
              items: [
                { text: "Aori", link: "/ecosystem/innovation-hubs/aori" },
                { text: "Suave", link: "/ecosystem/innovation-hubs/suave" },
                { text: "Arrakis", link: "/ecosystem/innovation-hubs/arrakis" },
                { text: "Squid", link: "/ecosystem/innovation-hubs/squid" },
                { text: "Anoma", link: "/ecosystem/innovation-hubs/anoma" }
              ]
            },
            {
              text: 'Solver Networks',
              collapsed: true,
              items: [
            ...
            },
            {
              ...
              collapsed: true,
              items: [
                { text: 'Wintermute', link: '/ecosystem/solvers/wintermute' },
                { text: 'PropellerHeads', link: '/ecosystem/solvers/propellerheads' },
                { text: 'Anera', link: '/ecosystem/solvers/anera' },
              ],
            },
            {
              text: 'Clearing',
              collapsed: true,
              items: [
                { text: 'Everclear', link: '/ecosystem/clearing/everclear' },
              ],
            },
            {
              ...
              collapsed: true,
              items: [
                { text: 'Halliday', link: '/ecosystem/commerce-automation/halliday' },
                { text: 'Fun.xyz', link: '/ecosystem/commerce-automation/funxyz' },
                { text: 'Decent', link: '/ecosystem/commerce-automation/decent' },
              ],
            },
            {
              ...
              collapsed: true,
              items: [
                { text: 'LayerZero', link: '/ecosystem/transport-layers/layerzero' },
                { text: 'Hyperlane', link: '/ecosystem/transport-layers/hyperlane' },
            ...
            {
              text: 'Rollup Clusters',
              collapsed: true,
              items: [
                { text: 'Astria', link: '/ecosystem/rollup-clusters/astria' },
                { text: 'Nodekit', link: '/ecosystem/rollup-clusters/nodekit' },
                { text: 'Radius', link: '/ecosystem/rollup-clusters/radius' },
                { text: 'Agglayer', link: '/ecosystem/rollup-clusters/agglayer' },
                { text: 'Metalayer', link: '/ecosystem/rollup-clusters/metalayer' },
                { text: 'Superchain', link: '/ecosystem/rollup-clusters/superchain' },
                { text: 'Orbit', link: '/ecosystem/rollup-clusters/orbit' },
                { text: 'Initia', link: '/ecosystem/rollup-clusters/initia' },
                { text: 'Dymension', link: '/ecosystem/rollup-clusters/dymension' },
              ],
            },
            {
              text: 'Fast Finality',
              collapsed: true,
              items: [
                { text: 'Espresso', link: '/ecosystem/fast-finality/espresso' },
                { text: 'Omni', link: '/ecosystem/fast-finality/omni' },
                { text: 'Nuffle', link: '/ecosystem/fast-finality/nuffle' },
                { text: 'Hyle', link: '/ecosystem/fast-finality/hyle' },
              ],
            },
          ],
        },
